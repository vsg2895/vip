            ...
            <div class="card-body">
                <form action="{{ route($route.'-admin-update', ['locale' => app()->getLocale(), 'currency' => 'amd', 'id' => $item->id]) }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <img src="{{ $image_path }}/backgrounds/{{ $item->img }}" class="responsive rounded" style="max-width: 100%;" alt="Image">
                        <input type="file" class="form-control mb-2" name="img" required>
                    </div>
