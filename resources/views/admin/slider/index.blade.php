    ...
    <div class="modal-dialog modal-lg" role="document">
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                ...
                <input type="text" form="add-new-item" class="form-control mb-2" name="title_hy" max="255" min="1" placeholder="Armenian" required>
            </div> 

            <!-- Description -->
            <div class="form-group">
                <label>Description</label>
                <textarea class="form-control mb-2" form="add-new-item" name="description_en" min="1" placeholder="English" required></textarea>
                <textarea class="form-control mb-2" form="add-new-item" name="description_ru" min="1" placeholder="Русский" required></textarea>
                <textarea class="form-control mb-2" form="add-new-item" name="description_hy" min="1" placeholder="Armenian" required></textarea>
            </div> 

            <!-- URL -->
            <div class="form-group">
                <label>URL</label>
                <input type="text" class="form-control mb-2" form="add-new-item" name="url" max="255" min="1" placeholder="URL" required>
            </div> 
