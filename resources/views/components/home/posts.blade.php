<!-- Contenet -->
<div class="app-container my-3 all-posts">
    <div class="row">
        <!-- Title -->
        <h2 class="font-weight-bold mb-3 text-dark text-center h2 w-100">{{ translating('home-section-posts-title') }}</h2>
