...
function preview_image(event){
  ...
  document.getElementsByClassName('output_image').style="display:block";
  var output = document.getElementsByClassName('output_image');
  output.src = reader.result;
  }
  reader.readAsDataURL(event.target.files[0]);
}
$('#checkBoxVideo').change(function(){
  if(this.checked){
    $('.video-content').find('input[name="video_url"]').attr('required','required');
    $('.video-content').stop().slideDown();
  }else{
    $('.video-content').find('input[name="video_url"]').removeAttr('required');
    $('.video-content').stop().slideUp();
  }
});
    ...
    if (apexChart.length > 0) {
        var colorPalette = ['#00D8B6','#008FFB',  '#FEB019', '#FF4560', '#775DD0']
            ...
            var apexdemo1 = jQuery('#apexdemo1')
               ...
               var chart = new ApexCharts(
                ...
                var dataNumbers = [];
                for(var i = 0; i < $('.article_type_ids').length; i++){
                  dataNumbers.push(Number($('.article_type_ids').eq(i).text()));
                }
                if (apexdemo7.length > 0) {
                  var optionDonut = {
                    ...
                    colors: ['#8E54E9','#2bcbba','#f7b731','#45aaf2','#e3324c', '#BB00D8', '#D86800', '#6AFF1F'],

                    series: dataNumbers,
                    labels: ['Breking', 'Entertainment', 'future', 'Popular', 'Header', 'Home Slider', 'Tranding', 'Video'],
                  }
                ...
                if (apexdemo8.length > 0) {
                  ...
                  var optionDonut = {
                    ...
                    colors: ['#8E54E9','#2bcbba','#f7b731','#45aaf2','#e3324c', '#BB00D8', '#D86800', '#6AFF1F'],
                    series: dataNumbers,
                    labels: ['Breaking  News', 'Entertainment News', 'Future News', 'Popular News', 'Header News', 'Home Slider News', 'Tranding News', 'Video News'],
                  }
        ...
        var analytics7 = jQuery('#analytics7')
            if (analytics7.length > 0) {
                var dataNumber = $('.day-view-count').text();
                var options = {
                    chart: {
                        type: 'bar',
                        width: 120,
            ...
            if (analytics8.length > 0) {
              ...
              var chart = new ApexCharts(
               ...
               // analytics9_2
                var analytics9_2 = jQuery('#analytics9')
               if (analytics9_2.length > 0) {
                var options = {
                    chart: {
                        type: 'bar',
                        width: 120,
              ...
              var chart = new ApexCharts(
                        document.querySelector("#analytics9_2"),
                        options
                    );
                    chart.render();
               }
...
(function(window, document, $, undefined){
    $(function(){
        ...
        if (summernote.length > 0) {
              ...
              $('#summernote_hy').summernote({
                tabsize: 2,
                height: 250
            });
            // $('.description_en').find('textarea').attr('name','description_en').attr('required','required').attr('form','add-new-article');
            // $('.description_ru').find('textarea').attr('name','description_ru').attr('required','required').attr('form','add-new-article');
            // $('.description_hy').find('textarea').attr('name','description_hy').attr('required','required').attr('form','add-new-article');
        }
    });
